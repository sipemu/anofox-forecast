...
- [ ] **IMPR-02**: The highest-value improvements are landed, each with a documented before/after delta in the relevant baseline file and a regression guard
- [ ] **IMPR-03**: Baseline updates after an improvement are committed deliberately (separate change), never auto-written by CI
