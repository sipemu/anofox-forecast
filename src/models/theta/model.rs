...
impl Theta {
    ...
    fn seasonal_test(series: &[f64], period: usize) -> bool {
        ...
        // Test: |r[m]| / stat > z_threshold
        let r_m = r[r.len() - 1]; // Last ACF value (at lag m)

        // Use z_90 (1.2816) instead of z_95 (1.6449) since this test is only
        // called when the user explicitly provides a seasonal_period, meaning
        // they expect seasonal handling. A less conservative threshold avoids
        // rejecting genuine seasonality.
